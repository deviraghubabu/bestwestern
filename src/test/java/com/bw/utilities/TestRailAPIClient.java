...
public class TestRailAPIClient {
	...
	public TestRailAPIClient(String base_url) {
		...
		this.setUser(ConfigManager.getProperty("TestRailUsername"));
		this.setPassword(ConfigManager.getProperty("TestRailPassword"));
	...
	private Object sendRequest(String method, String uri, Object data) throws Exception {
		...
		if (method.equals("POST")) {
			...
			// request body.
			if (data != null) {
				if (uri.startsWith("add_attachment")) // add_attachment API
														// requests
				{
